      ...
      <div className="min-h-screen text-center scroll-smooth bg-[#161312] text-white px-24 py-10">
        <div className="grid grid-cols-2">
          <div>
            ...
            <br/>
            <p className="text-3xl breathingText">Web Developer based in Stockton CA and always wanting to learn more</p>
          </div>
        ...
        <div className="grid grid-cols-3 pt-10 h-fit">
          <div className="grid grid-flow-row h-fit w-fill">
            ...
            <Image src={WeatherApp} alt="Weather App" className="imageZoom rounded-md" height={300} width={400}/>
            </Link>
          ...
          <div className="grid grid-rows-2 h-fit w-fill">
            <Link href={"https://fooa-project9-pokiapi.azurewebsites.net"} target="blank" className="flex justify-center">
              <Image src={PokeApi} alt="Pokemon Api" className="imageZoom rounded-md" height={300} width={400}/>
            </Link>
            <pre className="text-3xl pt-5 h-fit w-fit whitespace-pre-wrap">
              ...
              calling from Apis and displaying the data
            </pre>
          </div>
          <div className="grid grid-rows-2 h-fit w-fill">
            <Link href={"https://zealous-tree-095d4381e.5.azurestaticapps.net"} target="blank" className="flex justify-center">
              <Image src={CourtMonitor} alt="Court Monitor" className="imageZoom rounded-md" height={300} width={400}/>
            </Link>
        ...
        <div className="grid grid-cols-2 pt-8 gap-12">
          <div className="text-3xl">
            Languages:
            <div> 
              <ul className="flex flex-row gap-4 mt-5 justify-center breathingText">
